...
multislice_propagation_roi_merge_overlaps = False  # if True, merge overlapping padded ROI crops before propagation; safer for close OH/RH layouts but can be slower
